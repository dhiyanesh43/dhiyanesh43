...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=220&section=header&text=Dhiyanesh%20Mani&fontSize=55&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=AI%20Engineer%20in%20Progress%20%7C%20Full%20Stack%20AI%20Developer&descAlignY=58&descSize=18" width="100%"/>

<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&pause=1000&color=6C63FF&center=true&vCenter=true&width=600&lines=Building+AI+%E2%80%A2+Web+Apps+%E2%80%A2+Automation;Turning+Ideas+Into+Intelligent+Products;B.Tech+AI+%26+Data+Science+Student;Always+Learning%2C+Always+Building" alt="Typing SVG" />
</a>
...
class Dhiyanesh:
    def __init__(self):
        self.name = "Dhiyanesh Mani"
        self.role = "B.Tech AI & Data Science Student"
        self.location = "Chennai, Tamil Nadu, India 🇮🇳"
        self.goal = "Become a world-class AI Engineer & Full Stack AI Developer"
        self.currently_building = ["AI Agents", "LLM Applications", "Web Apps"]

    def philosophy(self):
        return "Clean code. Real problems. Continuous learning."
```

- 🔭 I love solving **real-world problems** with AI and code  
- ⚡ I enjoy building **AI-powered applications** end-to-end  
- 📚 I'm a **continuous learner** — new tools, new ideas, always  
- 🧩 I care about **clean, maintainable code**  
- 🚀 I'm driven by **innovation and impact**, not just novelty  
...
| 🧠 **LLMs & Agents** | AI Agents, Prompt Engineering, LLM-powered apps |
| 🌐 **Full Stack** | Flask, FastAPI, React, Firebase |
| ⚙️ **Automation** | n8n Workflow Automation |
| 🛠️ **Tooling** | Git & GitHub, developer workflows |
...
A web application that centralizes student analytics, performance tracking, and AI-driven insights in one clean interface.
...
An implementation exploring quantum cryptography principles for secure key exchange between parties.
...
### 🗺️ Route Optimization (A* Algorithm)
A pathfinding engine that computes optimal routes using the A* search algorithm with heuristic tuning.
...
A conversational AI assistant built with LLM integration, designed for natural, context-aware interactions.
...
An automated attendance system using real-time face recognition to eliminate manual roll calls.
...
### 🌐 Portfolio Website
A personal portfolio showcasing projects, skills, and journey as an AI & full-stack developer.
...
<img height="165" src="https://streak-stats.demolab.com?user=dhiyanesh43&theme=tokyonight&hide_border=true" />
...
**🏆 Hackathons**
<br/>
Participated in AI/ML hackathons, building solutions under time pressure
...
**🥇 Certifications**
<br/>
Ongoing certifications in AI, ML & Full Stack Development
...
**🎯 Coding Challenges**
<br/>
Regular practice on DSA and problem-solving platforms
...
**📚 Learning Journey**
<br/>
Documenting growth across AI, ML & Web Development
...
> I'd rather debug a stubborn model at 2 AM than leave a bug unsolved — the "aha" moment is always worth it. ☕🤖
